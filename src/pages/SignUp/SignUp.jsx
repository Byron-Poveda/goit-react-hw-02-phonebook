  ...
  return (
      <div className="bg-gray-100 text-gray-500 w-full h-screen flex items-center justify-center">
          <div className="md:flex w-full">
              <div className="hidden relative md:flex w-1/2 bg-indigo-500 py-10 px-10 h-screen justify-center items-center">
                  ...
                  <div className='absolute w-full h-full flex justify-center pt-[35px] bg-[#00000080]'>
